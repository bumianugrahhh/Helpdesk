...
<div class="container-fluid">
    ...
    <h4 class="h4 mb-0 text-gray-800"><i class="fa fa-fw fa-user"></i> Kelola Teknisi</h4>
    </div>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="{{ route('teknisi.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-user-plus fa-sm text-white-50"></i> Tambah Data</a>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <a href="" data-toggle="modal" data-target="#modalHapus" class="btn btn-sm btn-outline-danger" id="hapus-teknisi" data-id="{{$r->id_teknisi}}"><i class="fas fa-user-times"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
<div class="modal fade" id="modalHapus" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('teknisi.delete') }}" method="post">
                @csrf
...
<!-- Page level plugins -->
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", "#hapus-teknisi", function() {
